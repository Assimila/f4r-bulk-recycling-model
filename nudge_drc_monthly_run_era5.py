...
datao ="/Volumes/blue_wd/ESA_F4R/2026_rho/drc/" 
datap ="/Volumes/blue_wd/ESA_F4R/2026_plots/drc/" 
...
for YR in years:
    ...
    rho_xarr.to_netcdf(datao+L_NAME+"_"+S_NAME+"_drc_rot_rho_era5_"+str(YR)+".nc",engine=    "scipy")
